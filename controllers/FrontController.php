    ...
    public function index(Request $request, Response $response)
    {
        ...
        $this->view->render(
            ...
            [
                'config'           => $this->config,
                'class'            => 'index',
                'description'      => _('Fastest Video downloader for Youtube, FB, TED, Vimeo and other websites.'),
...
Note: Playlist URLs like https://www.youtube.com/watch?v=n1VJ39nVIBk&index=5&list=RDMMyP9KiFTyBks are not supported."));
            }
    ...
    {
        $uri = $request->getUri();
        $return = 'https://techbotvideodownloader.herokuapp.com/';
