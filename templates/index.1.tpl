...
<main class="main">
    ...
    alt="Video Downloader" width="250" height="250"></div>
    ...
    <br>
     <div id="bookmarklet" class="bookmarklet_wrapper">
      <p>  </p>
        <a class="bookmarklet small-font" href="javascript:void(open('https://techbotvideodownloader.herokuapp.com/{path_for name='video'}?url='+encodeURIComponent(location.href)+'&audio=on'));">{t}1-Click Mp3 Downloader{/t}</a>
        </div>
     <br>
    <div id="bookmarklet" class="bookmarklet_wrapper">
        <p>  </p>
